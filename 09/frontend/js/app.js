const apiUrlBase = 'http://localhost/Gustavo/tii09-uc7/09/api/cliente_api.php'; // Ajuste se necessário
...
const apiUrlProdutos = 'http://localhost/Gustavo/tii09-uc7/09/api/produto_api.php'; // Ajuste se necessário
